...
#创建一个 简单的神经网络
w1 = tf.Variable(tf.truncated_normal([784, 1000], stddev=0.1))#标准差
...
w3= tf.Variable(tf.truncated_normal([1000, 500], stddev=0.1))#标准差
...
w4 = tf.Variable(tf.truncated_normal([500, 10], stddev=0.1))#标准差
...
with tf.Session() as sess:
    ...
    for epoch  in range(21):
        ...
        print("after "+str(epoch) +"test accuracy" + str(test_cc)+"train accuracy" +str(train_cc))